...
Gem::Specification.new do |s|
  ...
  if RUBY_PLATFORM == 'java'
    ...
    #s.extensions = %w(src/ruby/ext/grpc-java/extconf.rb)
s.files += Dir.glob('src/ruby/ext/grpc-java/**/*')
    s.require_paths = %w( src/ruby/bin src/ruby/lib src/ruby/pb src/ruby/ext src/ruby/ext/grpc-java)
  else
    s.platform      = Gem::Platform::RUBY
    s.extensions = %w(src/ruby/ext/grpc/extconf.rb)
    s.files += Dir.glob('src/ruby/ext/grpc/**/*')
